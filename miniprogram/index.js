function createMiniProgramLicenseClient(options) {
  ...
  function validPayload(p) {
    ...
    const allowed = { licenseId: 1, appId: 1, majorVersion: 1, plan: 1, features: 1, issuedAt: 1, expiresAt: 1, kid: 1 }
    ...
    return typeof p.licenseId === 'string' && !!p.licenseId && typeof p.appId === 'string' && !!p.appId &&
      ...
      typeof p.kid === 'string' && !!p.kid && (p.plan === undefined || (typeof p.plan === 'string' && !!p.plan)) &&
